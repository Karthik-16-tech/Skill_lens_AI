...
export const Navbar = () => {
  ...
  return (
    <motion.nav
      className="fixed top-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-8 px-8 py-3 rounded-full backdrop-blur-2xl border border-white/[0.08] shadow-[0_10px_40px_rgba(0,0,0,0.6),0_0_10px_rgba(45,212,191,0.06)]"
    ...
    >
      ...
      >
        ...
        <span className="text-sm font-bold tracking-wide">Skill lens</span>
      </div>
