...
import {
  ...
  BarChart3, Bell, User, LogOut, ChevronDown, Sparkles, Settings
} from "lucide-react";
...
const navItems = [
  ...
  { icon: Lightbulb, label: "AI Assessment", path: "/dashboard/recommendations" },
...
export const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Floating Navbar */}
      <motion.nav
        className="fixed top-5 left-5 z-50 flex items-center gap-4 px-6 py-2.5 rounded-full backdrop-blur-2xl border border-white/[0.08] shadow-[0_10px_40px_rgba(0,0,0,0.6),0_0_15px_rgba(45,212,191,0.08)]"
      ...
      >
        ...
        <div className="flex items-center gap-1.5 px-3 pr-4 border-r border-white/10 mr-1">
          ...
          <span className="text-xs font-bold tracking-wide hidden lg:block">Skill lens</span>
        </div>
